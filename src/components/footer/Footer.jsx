  ...
  return (
      <footer id="footer">
        <div className="footer_main section">
          <img src="/img/header_logo.svg" alt="logo" className="footer_logo" />
          ...
          <div className="footer_media_logo">
            <a href="#"><img src="/img/social media logo 1.svg" alt="telegram"/></a>
            <a href="#"><img src="/img/social media logo 2.svg" alt="whatsapp"/></a>
            <a href="#"><img src="/img/social media logo 3.svg" alt="youtube" /></a>
          </div>
