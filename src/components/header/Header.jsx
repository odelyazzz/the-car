    ...
    <header>
      ...
      <div className={`header_up section ${isMenuOpen ? 'active' : ''}`}>
        ...
        <div className="header_media_logo">
          <img src="/the-car/img/social_media_logo_1.svg" alt="telegram" />
          <img src="/the-car/img/social_media_logo_2.svg" alt="whatsapp" />
          <img src="/the-car/img/social_media_logo_3.svg" alt="youtube" />
        </div>
